...
'''
Если вместо 404 ошибки требуется выбросить другую ошибку,
например 403 («доступ запрещён»), или же вообще перенаправить
пользователя на какую-нибудь другую страницу
...
from django.core.exceptions import PermissionDenied
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if instance.author != request.user:
            # Здесь может быть как вызов ошибки, так и редирект
            # на нужную страницу.
